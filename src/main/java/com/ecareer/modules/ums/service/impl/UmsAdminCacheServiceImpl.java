...
import com.ecareer.common.service.RedisService;
import com.ecareer.modules.ums.mapper.UmsAdminMapper;
import com.ecareer.modules.ums.model.UmsAdminRoleRelation;
import com.ecareer.modules.ums.model.UmsResource;
import com.ecareer.modules.ums.model.UmsAdmin;
import com.ecareer.modules.ums.service.UmsAdminCacheService;
import com.ecareer.modules.ums.service.UmsAdminRoleRelationService;
...
public class UmsAdminCacheServiceImpl implements UmsAdminCacheService {
    ...
    public void delResourceListByRole(Long roleId) {
        ...
        if (CollUtil.isNotEmpty(relationList)) {
            ...
            List<String> keys =
                    relationList.stream().map(relation -> keyPrefix + relation.getAdminId()).collect(Collectors.toList());
    ...
    @Override
    public UmsAdmin getAdmin(String phone) {
